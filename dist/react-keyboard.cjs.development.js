...
var DefaultBoard = function DefaultBoard(props, ref) {
  ...
  React.useImperativeHandle(ref, function () {
    return {
      _keyButtonClick: function _keyButtonClick(parmas) {
...
var KeyBoardContext$1 = /*#__PURE__*/React.createContext({
  color: '#eaa050',
  modeList: ['handwrite', 'symbol'],
  handApi: '',
  transitionTime: 300,
...
var KeyBoard = function KeyBoard(options) {
  ...
  function setDefaultKeyBoardMode(mode) {
    var _options$modeList, _options$modeList2;
...
exports.KeyBoardContext = KeyBoardContext$1;
exports.default = KeyBoard;
//# sourceMappingURL=react-keyboard.cjs.development.js.map
